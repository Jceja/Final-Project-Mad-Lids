...
function storySetting(){
  ...
  var story = wordsB[0] + " is the ruler of " + wordsB[1] + ", he has been a ruller of " + wordsB[1] + " ,after he pulled the "
    + wordsB[2] + " out of a " + wordsB[3] + " stone. King " + wordsB[0] + " , had to find " + wordsB[4] +
    " to go kill a "+ wordsB[7] +" at "+ wordsB[8] + " ,Then " + wordsB[4]+ " went out to get a "
    + wordsB[5] + " and it's trusty " + wordsB[6]+ ". He was set off to kill off the " + wordsB[9] +" "
